...
namespace test_orcl.Extensions
{
    public static class RtfExtensions
    {
        ...
        public static string ConvertRtfToStr(this string inputRtf)
        {
            if (inputRtf == null) return string.Empty;
            ...
            return returnString.Replace("ý", "ư").Replace("Ý", "Ư").Replace("ð", "đ").Replace("õ", "ó").Replace("ã", "ă");
        }
    }
}